        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <h1 className="font-display text-5xl md:text-7xl font-light mb-8 leading-tight">
              ...
              <span className="text-brand-gold italic">in Oro-Medonte, Ontario.</span>
            </h1>
          ...
          >
            <h2 className="font-display text-3xl md:text-5xl text-brand-bonewhite mb-10">
              Why Oro-Medonte Homeowners Choose <span className="text-brand-gold italic">Golden Maple</span>
            </h2>
          ...
          <div className="mb-24">
            <h2 className="font-display text-3xl md:text-5xl text-brand-bonewhite mb-12">
              Our Services in <span className="text-brand-gold italic">Oro-Medonte</span>
            </h2>
          ...
          >
            <h2 className="font-display text-3xl md:text-5xl text-brand-bonewhite mb-10">
              Oro-Medonte Communities <span className="text-brand-gold italic">We Serve</span>
            </h2>
          ...
          >
            <h2 className="font-display text-3xl md:text-5xl text-brand-bonewhite mb-10">
              What Does Landscaping Cost <span className="text-brand-gold italic">in Oro-Medonte?</span>
            </h2>
