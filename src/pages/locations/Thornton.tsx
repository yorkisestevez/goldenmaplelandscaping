...
const COMMUNITIES = [
  "County Road 21 / 27 core — the village crossroads and original streets",
  "New subdivisions — recent builds adding homes to the hamlet's edges",
  "Thornton Crossing Plaza area — commercial-frontage properties and nearby homes",
  "Trans Canada Trail side — properties backing onto the trail corridor",
  "Cookstown edge — rural lots on Thornton's south side toward Cookstown",
  "Essa countryside — acreage properties surrounding the village",
];

const SERVICES = [
  {
    title: "Interlocking Stone Patios & Driveways",
    desc: "Interlocking installations built for Thornton's flat, fertile sand-plain soils — proper base depth and compaction so patios and driveways hold through Simcoe County freeze-thaw. Techo-Bloc, Permacon, and porcelain paver options.",
    link: "/services/interlocking-barrie",
  },
  {
    title: "Composite Decking",
    desc: "Low-maintenance composite decks for Thornton's village homes and new builds. TimberTech and Trex builds with custom railings, integrated In-Lite lighting, and designs that suit modest lot sizes and bigger rural properties alike.",
    link: "/services/composite-decking-barrie",
  },
  {
    title: "Retaining Walls",
    desc: "Functional and decorative retaining walls for Thornton's gentle grades — garden bed walls, raised patios, and armour stone features. Every wall built with proper drainage behind it.",
    link: "/services/retaining-walls-barrie",
  },
  {
    title: "Landscape Design",
    desc: "Full outdoor living design from concept to construction. 3D renderings tailored to your Thornton property — whether it's a compact village lot or a country acreage with room to dream.",
...
const FAQS = [
  {
    q: "Do you take on smaller projects in a village like Thornton?",
    a: "Absolutely. Village lots, front walkway refreshes, small patios, and garden bed walls are a big part of our Thornton work. No project is too small to deserve proper grading and drainage.",
  },
  {
    q: "Our lot is flat — do we still need to think about drainage?",
    a: "Yes — flat is exactly when drainage matters most. Thornton's flat terrain means water doesn't leave on its own; without positive grading away from the house, spring melt and heavy rain pool against foundations and turn backyards into swamps. We grade every project so water has somewhere to go.",
  },
  {
    q: "Do I need a permit for landscaping in Thornton?",
  ...
  {
    q: "Is there a travel charge for Thornton projects?",
    a: "No. We're based in Barrie — Thornton is within our core service area with no additional travel fees.",
  },
  {
...
const localBusinessSchema = {
  ...
  "description": "Premium landscaping and hardscape contractor serving Thornton, Ontario. Specializing in interlocking stone, composite decking, retaining walls, and landscape design.",
  "url": "https://goldenmaplelandscaping.ca/locations/thornton",
...
export default function ThorntonLanding() {
  return (
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <span className="flex items-center gap-2 font-sans text-xs tracking-widest uppercase text-brand-gold-dark mb-6">
              <MapPin size={16} /> Serving Thornton & Essa Township
            </span>
            <h1 className="font-display text-5xl md:text-7xl font-light mb-8 leading-tight">
              Premium Landscaping & Hardscape <br />
              <span className="text-brand-gold-dark italic">Contractor in Thornton, Ontario.</span>
            </h1>
            <p className="font-sans text-lg text-brand-muted leading-relaxed font-light mb-6 max-w-3xl">
              Thornton is a classic Simcoe County crossroads village — County Roads 21 and 27, the Trans Canada Trail, and flat, fertile farmland stretching in every direction. Recent subdivisions and the Thornton Crossing Plaza are bringing new life to the hamlet, and those new lots and older village properties alike share one need: landscaping built for flat ground, where grading and drainage decide everything. Golden Maple Landscaping designs and builds Thornton outdoor spaces that stay dry and level for the long haul.
            </p>
            <p className="font-sans text-base text-brand-muted leading-relaxed font-light mb-12 max-w-3xl">
              Based in Barrie, Thornton is just south of us — a quick trip for our crew with no travel surcharges and no subcontractors. Every project is handled in-house, from excavation to final walkthrough.
            </p>
            <div className="flex flex-col sm:flex-row items-center gap-5 mb-12">
              <Link
                to="/book"
                onClick={() => trackEngagement('cta_click', 'thornton_hero_quote')}
                className="btn-primary py-4 px-10"
              >
                Request Your Free Thornton Quote
              </Link>
              <a
                href={`tel:${publicContact.phoneTel}`}
                onClick={() => trackCall('thornton_hero_phone')}
          ...
          >
            <h2 className="font-display text-3xl md:text-5xl text-brand-bonewhite mb-10">
              Why Thornton Homeowners Choose <span className="text-brand-gold-dark italic">Golden Maple</span>
            </h2>
            <p className="font-sans text-base text-brand-muted font-light leading-relaxed mb-6 max-w-3xl">
              Flat village lots and new subdivisions look easy — until the first spring melt. We build Thornton projects around what flat ground actually demands:
            </p>
            <ul className="space-y-3 mb-10 max-w-3xl">
              <li className="font-sans text-sm text-brand-muted font-light"><strong className="text-brand-bonewhite">Positive grading, always</strong> — every project graded so water moves away from the house, even on dead-flat lots</li>
              <li className="font-sans text-sm text-brand-muted font-light"><strong className="text-brand-bonewhite">Village-scale and acreage-scale</strong> — from compact in-town lots to full country properties around Thornton</li>
              <li className="font-sans text-sm text-brand-muted font-light"><strong className="text-brand-bonewhite">New-build finishing</strong> — final grading, sod, and complete backyard design on Thornton's newer subdivision lots</li>
            </ul>
          ...
          <div className="mb-24">
            <h2 className="font-display text-3xl md:text-5xl text-brand-bonewhite mb-12">
              Our Services in <span className="text-brand-gold-dark italic">Thornton</span>
            </h2>
          ...
          >
            <h2 className="font-display text-3xl md:text-5xl text-brand-bonewhite mb-10">
              Thornton Areas <span className="text-brand-gold-dark italic">We Serve</span>
            </h2>
          ...
          >
            <h2 className="font-display text-3xl md:text-5xl text-brand-bonewhite mb-10">
              What Does Landscaping Cost <span className="text-brand-gold-dark italic">in Thornton?</span>
            </h2>
            ...
            <p className="font-sans text-sm text-brand-muted font-light mt-6">
              Village lot or country acreage, every Thornton property gets a free site visit and a detailed written quote. Use our <Link to="/cost-estimator?city=thornton" className="text-brand-gold-dark hover:underline">Cost Estimator</Link> for an instant ballpark first.
            </p>
          </motion.div>
          ...
          <div className="text-center bg-brand-surface p-12 md:p-16 border border-brand-dim/20 rounded-sm">
            <h2 className="font-display text-3xl md:text-4xl text-brand-bonewhite mb-6">
              Get Your Free Thornton Landscaping Quote
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-8">
              ...
              <a href={`tel:${publicContact.phoneTel}`} onClick={() => trackCall('thornton_phone')} className="flex items-center gap-3 font-sans text-sm text-brand-gold-dark hover:text-brand-bonewhite transition-colors">
