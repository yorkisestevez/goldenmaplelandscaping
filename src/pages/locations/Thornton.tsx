        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="font-sans text-sm text-brand-muted font-light mt-6">
              Village lot or country acreage, every Thornton property gets a site visit and a detailed written quote. Use our <Link to="/cost-estimator?city=thornton" className="text-brand-gold-dark hover:underline">Cost Estimator</Link> for an instant ballpark first.
            </p>
          </motion.div>
