        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-5 mb-12">
              <Link
                to="/contact"
                onClick={() => trackEngagement('cta_click', 'springwater_hero_quote')}
                className="btn-primary py-4 px-10"
              >
                Request Your Free Springwater Quote
              </Link>
              <a
                href={`tel:${publicContact.phoneTel}`}
                onClick={() => trackCall('springwater_hero_phone')}
          ...
          <div className="text-center bg-brand-surface p-12 md:p-16 border border-brand-dim/20 rounded-sm">
            ...
            <p className="font-sans text-brand-muted font-light mb-10 max-w-2xl mx-auto">
              Ready to build the outdoor space your property deserves? Contact Golden Maple Landscaping to discuss the current consultation and quote process.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-8">
              <Link to="/contact" className="btn-primary py-4 px-10">Request a Quote</Link>
              <a href={`tel:${publicContact.phoneTel}`} onClick={() => trackCall('springwater_phone')} className="flex items-center gap-3 font-sans text-sm text-brand-gold-dark hover:text-brand-bonewhite transition-colors">
