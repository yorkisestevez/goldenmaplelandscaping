...
const BLOG_POSTS = [
    ...
    excerpt: "If your landscaping quote lacks a separate excavation line item, you could be overpaying or getting a substandard base — here's what site prep costs in Barrie.",
