      ...
      <div className="bg-brand-nearblack min-h-screen pt-32 pb-24">
        <div className="container-custom max-w-3xl">
          ...
          <div className="prose prose-invert prose-brand max-w-none font-sans font-light text-brand-muted leading-relaxed space-y-6">
            ...
            <p>
              Questions about these terms: <a href={`mailto:${publicContact.email}`} className="text-brand-gold-dark hover:underline">{publicContact.email}</a><br />
              Phone: <a href={`tel:${publicContact.phoneTel}`} onClick={() => trackCall('terms_phone')} className="text-brand-gold-dark hover:underline">{publicContact.phoneDisplay}</a>
            </p>
          </div>
        </div>
      </div>
