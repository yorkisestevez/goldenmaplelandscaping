...
const PROJECT_DATA: Record<string, ProjectData> = {
  'shanty-bay-estate': {
    ...
    images: ['/images/projects/IMG_4826.jpg', '/images/projects/IMG_4826.jpg'],
  ...
  'front-entrance-grandeur': {
    ...
    duration: '2 weeks',
    investment: '$25,000+',
    heroImg: '/images/projects/barrie-walkway-entrance.jpg',
    images: ['/images/projects/barrie-walkway-entrance.jpg'],
  ...
  'lakeside-pool-decking': {
    ...
    heroImg: '/images/projects/patio-pergola.jpg',
    images: ['/images/projects/patio-pergola.jpg'],
    description: 'A Permacon paver patio paired with a cedar pergola and built-in seating — a complete outdoor living room for a Barrie backyard, built on a base deep enough to ignore twenty Ontario winters.',
    challenge: 'The yard pitched slightly toward the house and the family wanted a defined, shaded space for dining and entertaining that would feel like a true extension of the home — not a slab dropped on the lawn.',
    solution: 'We re-graded for positive drainage away from the foundation, laid the pavers on a 14" open-graded base, and anchored a cedar pergola with integrated seating to frame the space. Polymeric-sand joints and a crisp soldier-course border keep the edges clean for decades.',
    specs: ['14" compacted clear stone base', 'Permacon paver field with soldier-course border', 'Positive drainage re-grade', 'Polymeric-sand joints', 'Cedar pergola with built-in seating', 'Edge restraint on all perimeters'],
  },
