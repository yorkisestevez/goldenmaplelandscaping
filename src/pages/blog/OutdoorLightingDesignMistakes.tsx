...
export default function OutdoorLightingDesignMistakes() {
  const faqSchema = {
      ...
      "mainEntity": [
          ...
          },
          {
              ...
              "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Low-voltage (12V) landscape lighting connected to a plug-in transformer does not require a permit for the low-voltage cable runs. However, hardwired connections to a 120V outdoor circuit — for the transformer itself or for any line-voltage fixtures — require a permit and inspection in Simcoe County municipalities including Barrie, Innisfil, and Oro-Medonte. If you are unsure whether your planned installation triggers a permit, contractors can clarify this as part of the design conversation."
              }
          },
          {
              "@type": "Question",
  ...
  return (
    ...
    >
      ...
      <div dangerouslySetInnerHTML={{ __html: "<p>If you are planning a lighting upgrade for a Barrie, Innisfil, or Simcoe County property — or redesigning an outdoor space where lighting is part of the picture — contractors can produce a scaled lighting plan as part of the full design process. Reach out through the <a href='/contact'>contact page</a> and contractors will respond within one business day.</p>" }} />
    </BlogPostLayout>
  );
}
