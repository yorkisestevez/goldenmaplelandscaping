...
export default function BestTimeInstallPatio() {
  ...
  return (
    ...
    >
      ...
      <p>The fastest way to see if your project fits a 2026 window is the <Link to="/cost-estimator" className="text-brand-gold hover:underline">Golden Maple cost estimator</Link>. It uses real Carr Landscape Depot pricing and gives you a ballpark in 60 seconds — which is enough to know if a discovery call makes sense. From there we can usually slot a spring or fall window within one phone call.</p>
