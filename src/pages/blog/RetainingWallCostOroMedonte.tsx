  ...
  return (
    ...
    >
      ...
      <div className="not-prose my-10 overflow-x-auto">
        <p className="font-sans text-[11px] uppercase tracking-widest text-brand-gold-dark mb-3">Retaining wall block comparison: Permacon vs. Unilock vs. Techo-Bloc for Oro-Medonte installations</p>
      ...
      <div className="mt-8">
        <div className="mb-8">
          ...
          <div dangerouslySetInnerHTML={{ __html: "<p>Yes, if the wall exceeds 1 metre in height measured from the bottom of the footing. Walls below that threshold are generally exempt under Ontario Building Code, though you should confirm specific setback requirements with Oro-Medonte Township for your lot. Confirm permit, engineering, and inspection responsibilities in the written project scope.</p>" }} />
        </div>
        <div className="mb-8">
      ...
      <div dangerouslySetInnerHTML={{ __html: "<p>If you have a grade problem on your Oro-Medonte property — or anywhere across Simcoe County — contractors do a full on-site assessment before quoting. Contractors look at your soil, access, wall height, and drainage path before contractors put a number on paper. <a href=\"/contact\">Book a site visit</a> or use the <a href=\"/cost-estimator?type=wall&city=oro-medonte\">cost estimator</a> to get a ballpark first. Contractors build in Barrie, Oro-Medonte, Innisfil, Springwater, Orillia, Wasaga Beach, Midland, and Collingwood.</p>" }} />
    </BlogPostLayout>
  );
}
