    ...
    >
      ...
      <div className="mt-8">
        ...
        <div className="mb-8">
          ...
          <div dangerouslySetInnerHTML={{ __html: "<p>A quote missing site prep will typically show a single line for installation with no mention of excavation depth, base material, or disposal. Look for these three specifics: stated depth in millimetres or inches, named base material (clear stone vs. granular A), and explicit inclusion of debris disposal. If any of those three are absent, ask the contractor to break them out separately before comparing the quote to others. The guide on <a href='/resources/hidden-costs-cheap-landscaping'>hidden costs in cheap landscaping</a> covers the most common ways site prep gets buried.</p>" }} />
        </div>
      </div>
      ...
      <div dangerouslySetInnerHTML={{ __html: "<p>If you are comparing landscaping quotes in Barrie or anywhere across Simcoe County and want to know whether the numbers in front of you reflect real site prep, contractors are glad to walk through it with you. <a href='/contact'>Reach out to schedule a site visit</a> and contractors will show you exactly how contractors price excavation, base depth, and disposal — in writing, line by line. Or use the <a href='/cost-estimator'>project cost estimator</a> to build a scoped range for your own project before you call anyone.</p>" }} />
    </BlogPostLayout>
  );
}
