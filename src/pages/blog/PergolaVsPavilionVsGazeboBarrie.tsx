      ...
      "mainEntity": [
          {
              ...
              "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "A cedar pergola installed in Barrie typically costs $8,000–$14,000 for a 10×12 ft to 12×16 ft structure in 2026. Pressure-treated pine framing starts lower at $5,500–$8,000. Aluminum louvred pergolas with adjustable blades run $12,000–$18,000 installed. The main cost variables are size, material, footing type, and whether electrical or lighting is included."
              }
          },
          {
              "@type": "Question",
          ...
          },
          {
              ...
              "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "It depends on how you use the space. If you primarily entertain in July and August on dry evenings, a pergola at $8,000–$18,000 delivers the same outdoor room feel at a fraction of the cost. If you want to use the space from May through October regardless of weather — and you’re already investing in an interlocking patio base — the extra $10,000–$20,000 for a pavilion typically pays off in actual usability."
              }
          },
          {
              "@type": "Question",
              ...
              "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "A pressure-treated pine pergola on a 10×10 ft or 10×12 ft footprint is the most cost-effective permanent shade structure we install, starting at $5,500–$8,000 installed. It requires annual sealing to hold up through Simcoe County’s freeze-thaw cycles, but it’s a solid entry point if budget is the primary constraint. Cedar costs more upfront but carries lower annual maintenance than pressure-treated."
              }
          }
      ]
  };
  ...
  return (
    ...
    >
      <div className="not-prose mb-12 p-7 rounded-2xl border border-brand-gold/30 bg-gradient-to-b from-brand-gold/[0.08] to-transparent">
        ...
        <p className="font-sans text-base text-brand-bonewhite font-light leading-relaxed mb-0">A pergola costs $8,000–$18,000 installed in Barrie; a pavilion runs $18,000–$45,000; a gazebo sits in between at $12,000–$30,000. For resale value, a cedar or composite pergola paired with an interlocking patio typically returns the most dollars per square foot in Barrie’s market. A pavilion wins on all-weather usability if you entertain through the shoulder season from May through October. The right call depends on your lot size, how you use the space, and how much annual maintenance you want.</p>
      </div>
      ...
      <div className="mt-8">
        <div className="mb-8">
          ...
          <div dangerouslySetInnerHTML={{ __html: "<p>A cedar pergola installed in Barrie typically costs $8,000–$14,000 for a 10×12 ft to 12×16 ft structure in 2026. Pressure-treated pine framing starts lower at $5,500–$8,000. Aluminum louvred pergolas with adjustable blades run $12,000–$18,000 installed. The main cost variables are size, material, footing type, and whether electrical or lighting is included.</p>" }} />
        </div>
        <div className="mb-8">
        ...
        <div className="mb-8">
          ...
          <div dangerouslySetInnerHTML={{ __html: "<p>It depends on how you use the space. If you primarily entertain in July and August on dry evenings, a pergola at $8,000–$18,000 delivers the same outdoor room feel at a fraction of the cost. If you want to use the space from May through October regardless of weather — and you’re already investing in an interlocking patio base — the extra $10,000–$20,000 for a pavilion typically pays off in actual usability.</p>" }} />
        </div>
        <div className="mb-8">
          ...
          <div dangerouslySetInnerHTML={{ __html: "<p>A pressure-treated pine pergola on a 10×10 ft or 10×12 ft footprint is the most cost-effective permanent shade structure we install, starting at $5,500–$8,000 installed. It requires annual sealing to hold up through Simcoe County’s freeze-thaw cycles, but it’s a solid entry point if budget is the primary constraint. Cedar costs more upfront but carries lower annual maintenance than pressure-treated.</p>" }} />
        </div>
      </div>
