  ...
  const faqSchema = {
      ...
      "mainEntity": [
          ...
          },
          {
              ...
              "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "A pressure-treated pine pergola on a 10×10 ft or 10×12 ft footprint is the most cost-effective permanent shade structure contractors install, starting at $13,000–$16,000 installed. It requires annual sealing to hold up through Simcoe County’s freeze-thaw cycles, but it’s a solid entry point if budget is the primary constraint. Cedar costs more upfront but carries lower annual maintenance than pressure-treated."
              }
          }
      ]
  };
    ...
    >
      ...
      <div className="mt-8">
        ...
        <div className="mb-8">
          ...
          <div dangerouslySetInnerHTML={{ __html: "<p>A pressure-treated pine pergola on a 10×10 ft or 10×12 ft footprint is the most cost-effective permanent shade structure contractors install, starting at $13,000–$16,000 installed. It requires annual sealing to hold up through Simcoe County’s freeze-thaw cycles, but it’s a solid entry point if budget is the primary constraint. Cedar costs more upfront but carries lower annual maintenance than pressure-treated.</p>" }} />
        </div>
      </div>
      ...
      <div dangerouslySetInnerHTML={{ __html: "<p>If you’re weighing a pergola, pavilion, or gazebo for your Barrie or Simcoe County property, the best next step is a site visit. Contractors look at your lot size, setbacks, existing patio or foundation, drainage, and how you actually use the space before recommending a structure. Reach out through the <a href='/contact'>contact page</a> to schedule a consultation, or use the <a href='/cost-estimator?type=pergola'>cost estimator</a> to get a rough project range before contractors talk.</p>" }} />
    </BlogPostLayout>
  );
}
