  ...
  const faqSchema = {
      ...
      "mainEntity": [
          ...
          },
          {
              ...
              "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "TimberTech capped composite boards carry a 25-year structural warranty and a 30-year fade and stain warranty for residential installations. In practice, we expect properly installed boards to perform for 30 or more years. The subframe — pressure-treated joists, ledger, and beam — typically lasts 20-30 years in well-drained installations. The limiting factor in most Ontario composite deck lifespans is framing deterioration, not board failure, which is why annual subframe inspection matters."
              }
          },
          {
              "@type": "Question",
    ...
    >
      ...
      <div className="mt-8">
        ...
        <div className="mb-8">
          ...
          <div dangerouslySetInnerHTML={{ __html: "<p>No. Capped composite boards like TimberTech PrimeCollection and Vintage Collection have a polymer outer layer that replaces the function of stain and sealant. Applying deck stain or sealant to a composite board is not only unnecessary — it can interfere with the surface and void warranty coverage. The boards are engineered to hold their colour and shed moisture without any topical treatment, which is the main advantage over pressure-treated or cedar wood.</p>" }} />
        </div>
        <div className="mb-8">
        ...
        <div className="mb-8">
          ...
          <div dangerouslySetInnerHTML={{ __html: "<p>TimberTech capped composite boards carry a 25-year structural warranty and a 30-year fade and stain warranty for residential installations. In practice, we expect properly installed boards to perform for 30 or more years. The subframe — pressure-treated joists, ledger, and beam — typically lasts 20-30 years in well-drained installations. The limiting factor in most Ontario composite deck lifespans is framing deterioration, not board failure, which is why annual subframe inspection matters.</p>" }} />
        </div>
        <div className="mb-8">
