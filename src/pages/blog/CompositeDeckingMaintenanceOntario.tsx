  ...
  const faqSchema = {
      ...
      "mainEntity": [
          ...
          },
          {
              ...
              "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "TimberTech capped composite boards (PrimeCollection) carry a 25-year structural warranty and a 30-year fade and stain warranty for residential installations. AZEK Vintage — a different, fully-PVC TimberTech line — carries its own 50-year fade and stain warranty. In practice, we expect properly installed boards on either line to perform for 30 or more years. The subframe — pressure-treated joists, ledger, and beam — typically lasts 20-30 years in well-drained installations. The limiting factor in most Ontario composite deck lifespans is framing deterioration, not board failure, which is why annual subframe inspection matters."
              }
          },
          {
              "@type": "Question",
    ...
    >
      ...
      <div className="mt-8">
        ...
        <div className="mb-8">
          ...
          <div dangerouslySetInnerHTML={{ __html: "<p>TimberTech capped composite boards (PrimeCollection) carry a 25-year structural warranty and a 30-year fade and stain warranty for residential installations. AZEK Vintage — a different, fully-PVC TimberTech line — carries its own 50-year fade and stain warranty. In practice, we expect properly installed boards on either line to perform for 30 or more years. The subframe — pressure-treated joists, ledger, and beam — typically lasts 20-30 years in well-drained installations. The limiting factor in most Ontario composite deck lifespans is framing deterioration, not board failure, which is why annual subframe inspection matters.</p>" }} />
        </div>
        <div className="mb-8">
