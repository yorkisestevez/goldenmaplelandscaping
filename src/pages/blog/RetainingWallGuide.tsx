...
export default function RetainingWallGuide() {
  return (
    <BlogPostLayout
      ...
      seoTitle="Complete Retaining Wall Guide Simcoe County | Engineering & Materials | Golden Maple"
      seoDescription="Everything homeowners need to know about building retaining walls in Simcoe County. Covers engineering requirements, material options, drainage, permits, and costs."
    ...
    >
      ...
      <p>In Ontario, any retaining wall over <strong>1 metre (approximately 3.3 feet)</strong> in height technically requires an engineered design. Here's the practical breakdown:</p>

      <ul>
        <li><strong>Under 2 feet:</strong> Decorative garden walls. Minimal structural requirements.</li>
        <li><strong>2-4 feet:</strong> Structural but typically doesn't require a permit. Still needs proper engineering principles — base depth, drainage, and geogrid reinforcement.</li>
        <li><strong>Over 4 feet:</strong> Always get an engineered design. The forces involved are significant, and failure can damage your property or your neighbour's.</li>
        <li><strong>Any wall near a structure:</strong> If the wall is within the zone of influence of your home's foundation (typically 1:1 ratio from the base of the wall), get an engineer involved regardless of height.</li>
      </ul>
      ...
      <h2>The Drainage Problem Nobody Talks About</h2>
      ...
      <ul>
        ...
        <li><strong>Clear stone drainage zone</strong> behind the entire wall face (minimum 12" deep)</li>
        <li><strong>Proper outlet</strong> — that drain tile needs somewhere to go, either to daylight or a storm system</li>
        <li><strong>Compacted backfill</strong> in lifts, never dumped and left</li>
      </ul>

      <blockquote>
        <p>"A retaining wall without drainage is a dam. And dams fail. It's not a question of if — it's a question of when."</p>
      </blockquote>

      <h2>Cost Expectations in 2026</h2>

      <p>Retaining wall costs in Simcoe County vary widely based on height, material, site access, and soil conditions. Here are realistic ranges:</p>

      <ul>
        <li><strong>Small garden walls (under 2 ft):</strong> $150-$250 per linear foot</li>
        <li><strong>Structural walls (2-4 ft):</strong> $300-$500 per linear foot</li>
        <li><strong>Engineered walls (4+ ft):</strong> $500-$800+ per linear foot</li>
      ...
      <ul>
        <li>How deep will the base be? (Should be at minimum equal to the wall height)</li>
        <li>What drainage system are you installing? (If they say "none" — walk away)</li>
        <li>Will you use geogrid reinforcement? (Essential for walls over 3 feet)</li>
