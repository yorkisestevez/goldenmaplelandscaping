  ...
  return (
    <div className="bg-brand-nearblack min-h-screen">
      <SEO
        ...
        description="Founded by Yorkis Estevez in Barrie, Golden Maple delivers premium outdoor construction with precision craftsmanship. Meet our team and discuss project details."
      ...
      <section className="section-padding pt-48">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-40">
            {[
              { icon: Shield, title: "Coverage documentation", desc: publicClaimCopy(BUSINESS.credentials.wsib, 'Current coverage documentation is available.') },
                ...
                <div className="space-y-12">
                  ...
                  <ul className="space-y-10 font-sans text-lg text-brand-bonewhite font-light">
                    <li className="flex gap-6">
                      ...
                      Project-specific excavation, drainage, and base planning.
                    </li>
                    <li className="flex gap-6">
                      <span className="text-brand-gold-dark font-normal shrink-0">✓</span>
                      Project communication details confirmed in the written scope.
                    </li>
                    <li className="flex gap-6">
                      <span className="text-brand-gold-dark font-normal shrink-0">✓</span>
                      Written scope and current project terms confirmed before work begins.
                    </li>
                    <li className="flex gap-6">
                      <span className="text-brand-gold-dark font-normal shrink-0">✓</span>
                      Current written workmanship terms confirmed before work begins.
                    </li>
                    <li className="flex gap-6">
                      <span className="text-brand-gold-dark font-normal shrink-0">✓</span>
                      Site-management details confirmed in the written scope.
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="mb-40">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {[
                ...
                {
                  name: "Techo-Bloc",
                  strength: "Material options",
                  desc: "Ask us to confirm current material options and availability for your project."
                },
                {
                  name: "Permacon",
                  strength: "Material options",
          ...
          <div className="mb-40">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-12 font-sans text-xl md:text-2xl text-brand-muted leading-relaxed font-light">
                ...
                <p>
                  So instead of telling you how much we love this work (we do), here's what you can actually expect when we build for you: <span className="text-brand-bonewhite font-normal">written project terms and communication details confirmed before work begins.</span>
                </p>
                <p>
                  The parts you'll never see still matter: drainage, access, soil conditions, and detailing. Those details are reviewed before the written scope is finalized.
                </p>
                ...
                <div className="bg-brand-burgundy/10 border-l-2 border-brand-gold p-10 md:p-16 rounded-[2px]">
                  <p className="text-brand-bonewhite text-2xl md:text-3xl font-display font-light leading-tight">
                    <span className="text-brand-gold-dark">{publicClaimCopy(BUSINESS.credentials.workmanshipWarranty, 'Written workmanship terms are available.')}</span>
                  </p>
                </div>
                <p>
      ...
      <section className="section-padding bg-brand-burgundy text-brand-porcelain">
        <div className="container-custom text-center">
          ...
          <p className="font-sans text-lg text-brand-porcelain/80 max-w-2xl mx-auto mb-16 font-light">
            Start with a project conversation. We will confirm the current consultation, site-visit, design, and project-scope details directly.
          </p>
